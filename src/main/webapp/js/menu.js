...
function OpenMenu(cid,lurl,rurl,bid){
   if($Nav()=='IE'){
     ...
     if(cid > -1) top.document.frames.menu.location = './getMenusById.do?id='+cid;
     ...
     if(cid > -1) top.document.getElementById("menu").src = './getMenusById.do?id='+cid;
...
function logout(){
	window.parent.location.href="../login/logout.do";
}
