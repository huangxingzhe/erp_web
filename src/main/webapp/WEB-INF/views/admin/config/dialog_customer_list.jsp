	...
	<table height=30 cellspacing=0 cellpadding=0 width="100%" border=0>
			...
			<tr>
				<td>
					...
					<select name="type" id="type">
			    		...
			    		<option value="3" <c:if test="${type==3}">selected</c:if>>电话</option>
			    	</select>
		...
		<div class=listzone>
			<table cellspacing=0 cellpadding=3 width="100%" align=center border=0>
				<tbody>
					<tr class=list>
						<td width="20%" height=20 class=biaoti style="padding:0xp 0px;"><span
					...
					<c:forEach items="${customers}" var="customer" >
						<tr onclick="parent.window.selectCustomerItem('cusName','${customer.id}','${customer.code}','${customer.name}')" style="cursor:pointer;"
