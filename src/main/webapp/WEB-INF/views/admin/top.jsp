...
<div class="topnav">
	<div class="sitenav">
		<div class="welcome">
            ...
            <a href="<%=basePath%>/admin/user/editPass.do" target="main" style="text-decoration:underline ;"><spring:message code="admin.top.updatepass"/></a>
			<a href="../login/logout.do" target="_parent" style="text-decoration:underline ;"><spring:message code="admin.top.logout"/></a>
