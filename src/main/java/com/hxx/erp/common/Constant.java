...
public class Constant {
	...
	public static final String SESSION_LOGIN_ADMIN_ID = "session_login_admin_id";
	public static final String SESSION_LOGIN_ADMIN_ACCOUNT = "session_login_admin_account";
